...
interface ICodeFrameComponent {
    children: React.ReactNode,
    fileName: string
    fileContent: string
}

export default class CodeFrame extends Component<ICodeFrameComponent> {
    handleDownloadClick = () => {
            ...
            <div className="code-wrapper">
                <div className="code-frame code-wrapper__code-frame">
                    ...
                    <CodeFrameHeader>
                        ...
                        <Button className="code-frame__button" onClick={this.handleDownloadClick} type="button">
